...
export const NAV_ITEMS = [
  { label: "What is Ally", href: "#what-is-ally" },
...
export const KEY_MESSAGES = [
  ...
  "Judgment is now the differentiator.",
  "Ship fast. Prove the win. Scale what works.",
];

export const TARGET_AUDIENCES = [
  {
    title: "You're building the business",
    description:
  ...
  {
    title: "You're running the business",
    description:
...
export const HIRING_ROLES = [
  ...
  {
    title: "Senior Executive Partner / Partner Success",
    responsibilities: [
